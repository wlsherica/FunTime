...
a='127.0.0.1 - - [01/Aug/1995:00:00:01 -0400] "GET /images/launch-logo.gif HTTP/1.0" 200 1839'
print parseApacheLogLine(a)[:]
...
dayHostCount = dayGroupedHosts.map(lambda x: (x[0], len(list(set(x[1])))))
